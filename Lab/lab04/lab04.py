def divide(quotients, divisors):
    ...
    """
    return {quotients[index]: [divisor for divisor in divisors if divisor % quotients[index] == 0] for index in range(len(quotients))}
...
def buy(fruits_to_buy, prices, total_amount):
    ...
    def add(fruits, amount, cart):
        if fruits == [] and amount == 0:
            ...
            fruit = fruits[0]
            price = prices[fruit]
            print("DEBUG:", "fruit:", fruit, "price:", price)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    dis_a = distance(city_temp, city_a)
    dis_b = distance(city_temp, city_b)
